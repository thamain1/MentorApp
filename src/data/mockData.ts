...
export const testUsers: Record<UserRoleType, TestUser> = {
  admin: {
    ...
    interests: ['Mentorship', 'Community Service', 'Faith & Spirituality', 'Public Speaking'],
    goals: ['Community Impact', 'Leadership Skills', 'Networking'],
    specialties: ['Leadership Development', 'Community Leadership', 'Networking & Mentorship'],
    location: 'Chicago, IL',
    avatar_url: null,
  ...
  mentor: {
    ...
    specialties: ['Tech & Coding', 'Career Coaching', 'Leadership Development'],
    location: 'Chicago, IL',
    avatar_url: null,
...
export const mockMentorProfile: Profile = {
  ...
  interests: ['Technology', 'Fitness', 'Entrepreneurship', 'Faith & Spirituality'],
  goals: ['Leadership Skills', 'Career Development'],
  specialties: ['Career Coaching', 'Tech & Coding', 'Leadership Development'],
  location: 'Chicago, IL',
...
const mockProfiles: Profile[] = [
  mockMentorProfile,
  {
    ...
    specialties: ['Faith & Discipleship', 'Sports Mentorship', 'Confidence Building'],
    location: 'Chicago, IL',
    avatar_url: null,
...
export const mockAvailableMentors: MentorProfile[] = [
  ...
  },
  {
    ...
    goals: ['Personal Growth', 'Communication'],
    specialties: ['Confidence Building', 'Sports Mentorship', 'Faith & Discipleship'],
    location: 'Chicago, IL',
  ...
  },
  {
    ...
    interests: ['Fitness', 'Investing', 'Sports', 'Reading'],
    goals: ['Financial Literacy', 'Health & Wellness'],
    specialties: ['Financial Literacy', 'Academic Tutoring', 'Fitness & Health'],
    location: 'Chicago, IL',
  ...
  },
  {
    ...
    interests: ['Entrepreneurship', 'Business', 'Cooking', 'Travel'],
    goals: ['Leadership Skills', 'Career Development'],
    specialties: ['Entrepreneurship', 'Leadership Development', 'Communication Skills'],
    location: 'Chicago, IL',
  ...
  },
  {
    ...
    interests: ['Business', 'Public Speaking', 'Mentorship', 'Golf'],
    goals: ['Leadership Skills', 'Communication'],
    specialties: ['Leadership Development', 'Career Coaching', 'Public Speaking'],
    location: 'Chicago, IL',
  ...
  },
  {
    ...
    interests: ['Community Service', 'Social Justice', 'Music', 'Fitness'],
    goals: ['Personal Growth', 'Health & Wellness'],
    specialties: ['Emotional Intelligence', 'Life Skills', 'Mental Health Awareness'],
    location: 'Chicago, IL',
